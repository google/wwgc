...
return c}(c,this)};l.Service=h;var t=function(a,b,c,d){q.call(this,a,b,c);this.className="Service.Method";this.options=d||{}};(t.prototype=Object.create(q.prototype)).buildOpt=b.buildOpt;l.Service.Method=t;b=function(a,b,c,d,e,f){t.call(this,a,b,c,f);this.className="Service.RPCMethod";this.requestName=d;this.responseName=e;this.resolvedResponseType=this.resolvedRequestType=null};b.prototype=Object.create(t.prototype);l.Service.RPCMethod=b;return l}(f);f.Builder=function(c,e,f){var l=function(b){this.ptr=
...
q={};if(a.oneofs)for(var k=Object.keys(a.oneofs),g=0,n=k.length;g<n;++g)e.addChild(q[k[g]]=new f.Message.OneOf(this,e,k[g]));if(a.fields&&0<a.fields.length)for(g=0,n=a.fields.length;g<n;++g){k=a.fields[g];if(null!==e.getChild(k.id))throw Error("Duplicate field id in message "+e.name+": "+k.id);if(k.options)for(var m=Object.keys(k.options),p=0,s=m.length;p<s;++p){if("string"!==typeof m[p])throw Error("Illegal field option name in message "+e.name+"#"+k.name+": "+m[p]);if("string"!==typeof k.options[m[p]]&&
